...
const REGIONS = {
  ...
  '경기': {
    ...
    areas: {
      ...
      '안산시': { dongs:['단원구','상록구'], feature:'반월·시화 국가산업단지 인근. 다문화·외국인 가정 비율 높아 한국어·영어 교육 수요 특화. 스마트허브 조성으로 IT 과외 수요 증가.', schools:'안산고, 안산강서고, 초지고' },
      '평택시': { dongs:['비전동','신장동','안중읍','팽성읍'], feature:'삼성전자 평택캠퍼스 입주로 고학력 가정 급증. 브레인시티·고덕국제신도시 개발로 교육 수요 폭발적 증가.', schools:'비전고, 한광고, 한광여고' },
      '시흥시': { dongs:['배곧동','장현동','목감동','은계동'], feature:'배곧 신도시·스마트허브 조성. 안산·부천 인접으로 교육 수요 높음. 젊은 가족층 지속 유입.', schools:'시흥고, 능곡고, 배곧고' },
      '파주시': { dongs:['교하동','운정동','금촌동','문산읍'], feature:'운정 신도시 대규모 개발. 서울 접근성 개선으로 교육 수요 급증. 출판단지 인근 문화·어학 교육 수요 특화.', schools:'교하고, 심학고, 문산제일고' },
      '김포시': { dongs:['장기동','운양동','구래동','사우동'], feature:'한강신도시 개발 완료. 서울 강서구 인접. 젊은 고학력 가정 대거 유입으로 교육 수요 급성장.', schools:'솔터고, 운양고, 제일고' },
      '의정부시': { dongs:['의정부동','신곡동','송산동','가능동'], feature:'서울 노원 인접 교육 도시. 경기 북부 교육 중심지. 내신 관리 중심 과외 수요 꾸준.', schools:'의정부고, 효자고, 경민고' },
      '광주시': { dongs:['경안동','탄벌동','오포읍','초월읍'], feature:'서울 강동·성남 인접. 타운하우스·전원주택 고급 주거지. 젊은 고학력 가정 이주로 교육 수요 빠르게 성장.', schools:'광주고, 광주중앙고' },
      '하남시': { dongs:['미사동','위례동','덕풍동','감일동'], feature:'미사강변·감일지구 신도시 개발. 서울 강동 인접. 젊은 고학력 가정 대거 유입. 내신·수능 과외 수요 급증.', schools:'미사고, 강일고, 신장고' },
      '광명시': { dongs:['철산동','하안동','소하동','광명동'], feature:'서울 구로·금천 인접 교육 도시. 광명역세권 KTX 개발로 교육 환경 개선. 합리적 비용 과외 수요 높음.', schools:'광명고, 광문고, 소하고' },
      '군포시': { dongs:['산본동','당정동','부곡동','대야동'], feature:'산본 신도시 중심. 안양 평촌 인접 교육 환경. 내신 관리 과외 수요 꾸준.', schools:'산본고, 군포고, 흥진고' },
      '이천시': { dongs:['창전동','중리동','부발읍','장호원읍'], feature:'SK하이닉스 본사 인근. 반도체 연구원 가정 밀집. 이공계·코딩 과외 수요 높음.', schools:'이천고, 이현고, 효양고' },
      '오산시': { dongs:['오산동','세마동','초평동','궐동'], feature:'삼성전자·LG전자 협력업체 밀집. 화성 동탄 인접. 젊은 맞벌이 가정 비율 높아 방문 과외 수요 높음.', schools:'오산고, 운천고, 세교고' },
      '양주시': { dongs:['회천읍','광적면','옥정동','덕계동'], feature:'옥정 신도시 개발 완료. 서울 도봉·의정부 인접. 젊은 가족층 유입으로 초등 조기교육 수요 성장.', schools:'양주고, 회암고' },
      '구리시': { dongs:['갈매동','인창동','수택동','교문동'], feature:'서울 광진·중랑 인접 교육 도시. 갈매 신도시 개발 완료. 내신 관리 중심 과외 수요 꾸준.', schools:'인창고, 수택고, 구리고' },
      '안성시': { dongs:['공도읍','안성동','미양면','보개면'], feature:'삼성·LG 협력사 밀집. 국내 최대 낙농지역이지만 공도읍 중심 신흥 주거지 교육 수요 성장.', schools:'안성고, 안성여고' },
      '의왕시': { dongs:['내손동','오전동','청계동','포일동'], feature:'과천·안양 인접. 한국교통대·성결대 인근. 의왕 포일·내손 신도시 교육 수요 꾸준.', schools:'의왕고, 백운고' },
      '여주시': { dongs:['여주읍','오학동','가남읍','점동면'], feature:'경강선 개통으로 서울 접근성 향상. 신규 아파트 입주로 젊은 가족층 유입. 교육 수요 성장 중.', schools:'세종고, 여주고, 여주여고' },
      '동두천시': { dongs:['생연동','중앙동','지행동','소요동'], feature:'경기 북부 소도시. 미군부대 인근 영어 교육 수요 특화. 합리적 비용 방문 과외 선호.', schools:'동두천고, 동두천여고' },
      '과천시': { dongs:['과천동','별양동','부림동','중앙동'], feature:'정부청사·국립과천과학관 인근. 공무원·연구원 가정 비율 최상위. 수능 상위권 배출률 전국 최상위 소도시.', schools:'과천고, 과천외고' },
      '가평군': { dongs:['가평읍','청평면','설악면','상면'], feature:'청평·가평 자연환경 속 전원 주거지. 서울 근접 귀촌 가정 증가. 방문 과외 수요 높음.', schools:'가평고, 청평고' },
      '양평군': { dongs:['양평읍','용문면','강상면','지평면'], feature:'두물머리 인근 전원 주거지. 서울 강동·광진 귀촌 가정 증가. 초등 홈스쿨링·방문 과외 수요 높음.', schools:'양평고, 용문고' },
      '연천군': { dongs:['연천읍','전곡읍','청산면','미산면'], feature:'경기 최북단 소도시. 농촌 지역으로 방문 과외 수요 높음. 합리적 비용 선호.', schools:'연천고, 전곡고' },
      '포천시': { dongs:['포천읍','소흘읍','군내면','가산면'], feature:'경기 북부 소도시. 의정부 인접. 젊은 가족 이주로 초등 과외 수요 증가 중.', schools:'포천고, 포천일고' },
    }
  },
  '인천': {
    label: '인천광역시', emoji: '✈️',
    areas: {
      ...
      '미추홀구': { dongs:['주안동','숭의동','학익동','용현동'], feature:'인천 원도심 핵심 지역. 인하대 인근으로 이공계 교육 수요 높음. 학원가 발달로 내신 관리 수요 꾸준.', schools:'인하고, 인천고, 미추홀외고' },
      '계양구': { dongs:['계산동','작전동','귤현동','박촌동'], feature:'인천 북부 주거 밀집 지역. 서울 부평·김포 인접. 내신 관리 중심 과외 수요 꾸준.', schools:'계양고, 인천계산고' },
      '서구': { dongs:['검단동','청라동','루원시티','왕길동'], feature:'청라 국제도시·검단 신도시 개발로 젊은 가족층 급증. 인천 서부 신흥 교육 지역. 초등 조기교육 과외 수요 폭증.', schools:'청라고, 해원고, 신현고' },
      '강화군': { dongs:['강화읍','불은면','선원면','하점면'], feature:'인천 서쪽 섬 지역. 방문 과외 수요 높음. 역사·문화 교육 수요 특화. 합리적 비용 선호.', schools:'강화고, 강화여고' },
      '옹진군': { dongs:['북도면','자월면','덕적면','백령면'], feature:'인천 도서 지역. 원거리 섬 특성상 온라인 과외 수요 높음. 합리적 비용 선호.', schools:'영흥고' },
      '중구': { dongs:['신포동','답동','운서동','영종도'], feature:'인천국제공항이 위치한 영종도와 인천 구도심을 포함. 항공·물류 업계 종사자 가정 비율 높아 영어 교육 수요 특화.', schools:'인천중구고, 인천항도고' },
      '동구': { dongs:['화수동','송현동','금창동','만석동'], feature:'인천 구도심 지역. 합리적 비용의 내신 관리 과외 수요 꾸준. 방문 과외 선호도 높음.', schools:'인천동구고' },
    }
  },
  '부산': {
    label: '부산광역시', emoji: '🌊',
    areas: {
      ...
      '연제구': { dongs:['거제동','연산동','연제동'], feature:'부산시청 인근 행정·주거 복합지역. 거제중·연제고 학군. 공무원·전문직 가정 비율 높아 내신 관리 과외 수요 높음.', schools:'연제고, 연일고, 남여고' },
      '부산진구': { dongs:['부전동','전포동','범천동','개금동'], feature:'부산 최대 상권 서면 인근. 부산 중심 교육 지역. 학원가 밀집으로 1:1 과외 병행 수요 높음.', schools:'개금고, 부산진고, 데레사여고' },
      '영도구': { dongs:['봉래동','청학동','동삼동','신선동'], feature:'부산 도서 지역. 한국해양대 인근. 해양·공학 계열 진학 수요 특화. 내신 관리 과외 수요 꾸준.', schools:'영선고, 대각고' },
      '사상구': { dongs:['괘법동','모라동','삼락동','학장동'], feature:'낙동강 인근 산업·주거 복합지역. 합리적 비용 내신 관리 과외 수요 꾸준. 방문 과외 선호.', schools:'사상고, 모덕고' },
      '사하구': { dongs:['괴정동','하단동','다대동','당리동'], feature:'부산 남서부 주거 밀집 지역. 합리적 비용 내신 관리 과외 수요 꾸준. 1:1 방문 과외 선호.', schools:'사하고, 구평고, 다대고' },
      '금정구': { dongs:['구서동','장전동','부곡동','금사동'], feature:'부산대 인근 교육 특화 지역. 이공계·의대 진학 수요 높음. 대학생 과외 선생님 풍부.', schools:'부산고, 금정고, 브니엘고' },
      '기장군': { dongs:['기장읍','장안읍','정관읍','일광읍'], feature:'정관 신도시 개발로 젊은 가족층 급증. 부산 동부 신흥 교육 지역. 초등 조기교육 과외 수요 성장.', schools:'정관고, 기장고' },
      '남구': { dongs:['대연동','용호동','문현동','감만동'], feature:'부경대·경성대 인근 교육 도시. 대학가 인근 과외 선생님 풍부. 내신 관리·수능 대비 과외 수요 꾸준.', schools:'경남고, 부산남고, 성지여고' },
      '동구': { dongs:['초량동','수정동','좌천동','범일동'], feature:'부산역 인근 구도심. 부산 원도심으로 재개발 진행 중. 합리적 비용 내신 관리 과외 수요 꾸준.', schools:'개성고, 동성고' },
      '중구': { dongs:['남포동','광복동','중앙동','영주동'], feature:'부산 최대 상권 인근. 부산 구도심 교육 지역. 방문 과외 수요 높고 합리적 비용 선호.', schools:'부산중앙고, 경남상고' },
      '서구': { dongs:['동대신동','서대신동','부민동','아미동'], feature:'부산대병원 인근 의료·주거 복합지역. 의대 준비 학생들의 과학·수학 과외 수요 있음.', schools:'부산고, 경남여고' },
      '북구': { dongs:['구포동','덕천동','화명동','만덕동'], feature:'화명 신도시를 중심으로 부산 북부 최대 주거지역. 화명고·성도고 학군. 내신 관리 과외 수요 꾸준.', schools:'화명고, 성도고, 구포고' },
      '강서구': { dongs:['명지동','강동동','녹산동','가덕도'], feature:'에코델타시티·명지지구 개발로 젊은 가족층 급증. 부산 서부 신흥 교육 지역. 초등 조기교육 과외 수요 빠르게 성장.', schools:'명지고, 강서고' },
    }
  },
  '대구': {
    label: '대구광역시', emoji: '🔵',
    areas: {
      ...
      '북구': { dongs:['침산동','구암동','칠성동','복현동'], feature:'대구 북부 주거 밀집 지역. 경북대 인근 이공계 교육 특화.', schools:'구암고, 경명여고, 함지고' },
      '동구': { dongs:['율하동','동촌동','안심동','혁신도시'], feature:'대구 동부 신흥 주거지역. 이시아폴리스 등 신도시 개발로 교육 수요 급증.', schools:'영신고, 경상고, 강동고' },
      '중구': { dongs:['동성로','수창동','대봉동','봉산동'], feature:'대구 도심 중심부. 전통 있는 명문 학교 밀집. 수성구 인접 영향으로 교육열 높음.', schools:'사대부고, 경북여고, 신명고' },
      '서구': { dongs:['내당동','비산동','평리동','원대동'], feature:'대구 서부 주거지역. 실용적 내신 관리 과외 수요 꾸준.', schools:'성화여고, 대건고' },
      '남구': { dongs:['대명동','봉덕동','이천동'], feature:'대구 남부 주거 지역. 영남대 인근 이공계 교육 수요 높음.', schools:'대륜고, 경북예고' },
      '달성군': { dongs:['현풍읍','테크노폴리스','화원읍','옥포읍'], feature:'테크노폴리스 조성으로 IT 기업 종사자 가정 급증. 코딩·수학 과외 수요 폭발적 증가.', schools:'현풍고, 달성고' },
      '군위군': { dongs:['군위읍','의흥면','효령면','부계면'], feature:'대구 편입 신규 지역. 농촌 지역으로 방문 과외 수요 높음. 대구 인접성 활용 교육 인프라 개선 중.', schools:'군위고, 군위여고' },
    }
  },
  '광주': {
    label: '광주광역시', emoji: '🌸',
    areas: {
      '서구': { dongs:['상무지구','치평동','화정동','금호동'], feature:'상무지구 중심 광주 최고 교육 특구. 학원가 밀집으로 전남 전역에서 유학 오는 지역.', schools:'전남고, 상무고, 광주여고' },
      '북구': { dongs:['용봉동','일곡동','신용동','운암동'], feature:'전남대·조선대 인근. 이공계·의치대 진학 수요 높음.', schools:'광덕고, 숭일고, 동신고' },
      '광산구': { dongs:['수완지구','첨단지구','선운지구','신창동'], feature:'수완·첨단 신도시 중심 신흥 교육 지역. 젊은 학부모층 밀집.', schools:'수완고, 장덕고, 숭덕고' },
      '남구': { dongs:['봉선동','주월동','진월동','사직동'], feature:'봉선동 학원가 형성. 상위권 대학 진학률 높은 주요 학군.', schools:'전남여고, 동아여고, 광주고' },
      '동구': { dongs:['충장로','서석동','계림동','학동'], feature:'광주 원도심. 역사 깊은 교육 명문 지역. 문화예술 특기 교육 수요 높음.', schools:'조선대부고, 금호중앙여고' },
    }
  },
  '대전': {
    label: '대전광역시', emoji: '🌾',
    areas: {
      '유성구': { dongs:['노은동','지족동','반석동','관평동'], feature:'카이스트·충남대 인근. 이공계 최고 교육 특구. 과학고·영재학교 준비 수요 전국 최상위.', schools:'대전과학고, 반석고, 지족고' },
      '서구': { dongs:['둔산동','관저동','도안동','가수원동'], feature:'둔산 신도시 중심 대전 최대 교육 지역. 학원가 밀집으로 전북·충남 학생 유학 올 정도.', schools:'유성고, 도안고, 서대전여고' },
      '대덕구': { dongs:['송촌동','법동동','오정동','신탄진동'], feature:'대덕연구단지 인근. 연구원·공학자 자녀 이공계 교육 수요 특화.', schools:'송촌고, 우송고' },
      '중구': { dongs:['태평동','문화동','대흥동','중촌동'], feature:'대전 원도심. 전통 명문 학교 밀집. 내신 관리 중심 과외 수요 꾸준.', schools:'대신고, 보문고' },
      '동구': { dongs:['판암동','성남동','용전동','대동'], feature:'대전 동부 주거지역. 합리적 비용 과외 수요 높음.', schools:'가오고, 동대전고' },
    }
  },
  '울산': {
    label: '울산광역시', emoji: '⚙️',
    areas: {
      '남구': { dongs:['삼산동','달동','무거동','신정동'], feature:'현대자동차·SK에너지 인근. 울산 최대 교육 지역. 이공계·의대 진학 수요 높음.', schools:'현대고, 학성고, 울산여고' },
      '북구': { dongs:['화봉동','송정동','창평동','연암동'], feature:'현대자동차 공장 인근 산업·주거 복합지역. 맞벌이 가정 많아 방문 과외 수요 높음.', schools:'화봉고, 매곡고' },
      '동구': { dongs:['일산동','방어동','전하동','화정동'], feature:'현대중공업 인근. 조선·해양 산업 종사자 가정 밀집. 실용적 교육 수요 높음.', schools:'울산중앙고, 동구고' },
      '중구': { dongs:['학성동','북정동','복산동','남외동'], feature:'울산 원도심. 전통 명문 학교 밀집. 내신 관리 중심 과외 수요 꾸준.', schools:'울산고, 학성고, 울산여고' },
      '울주군': { dongs:['언양읍','온산읍','삼남읍','범서읍'], feature:'울산 외곽 주거·산업 지역. 대규모 공단 종사자 가정 밀집. 방문 과외 선호.', schools:'언양고, 삼동고' },
    }
  },
  '세종': {
    label: '세종특별자치시', emoji: '🏛',
    areas: {
      '세종시': { dongs:['새롬동','도담동','아름동','종촌동','고운동','소담동','보람동','대평동'], feature:'행정중심복합도시. 공무원·연구원 가정 밀집. 수도권 수준의 높은 교육열. 신도시 개발 완료로 학원가 급성장.', schools:'세종고, 양지고, 새롬고, 다정고' },
    }
  },
  '강원': {
    label: '강원특별자치도', emoji: '🏔',
    areas: {
      '춘천시': { dongs:['석사동','후평동','퇴계동','소양동'], feature:'강원도청 소재지. 강원대·한림대 인근 교육 인프라 발달. 도내 학생들의 유학 목적지.', schools:'강원고, 춘천고, 춘천여고' },
      '원주시': { dongs:['단구동','무실동','혁신도시','명륜동'], feature:'강원 최대 도시. 연세대 원주캠퍼스 인근. 의대·이공계 진학 수요 높음.', schools:'원주고, 대성고, 북원여고' },
      '강릉시': { dongs:['포남동','교동','홍제동','성덕동'], feature:'동해안 최대 도시. 관광·교육 공존. 명문 학교 전통 강함.', schools:'강릉고, 강릉여고, 강릉제일고' },
      '동해시': { dongs:['천곡동','송정동','북평동','묵호동'], feature:'강원 동해안 산업 도시. 동해항 인근. 합리적 비용 내신 관리 과외 수요 꾸준.', schools:'동해고, 북평고' },
      '태백시': { dongs:['황지동','장성동','문곡동','철암동'], feature:'강원 탄광 도시. 인구 감소 중이나 지역 명문 학교 중심 내신 관리 수요 꾸준.', schools:'태백고, 강원관광고' },
      '속초시': { dongs:['조양동','영랑동','청호동','노학동'], feature:'강원 동해안 관광도시. 관광·외식업 종사자 가정 많아 합리적 비용 과외 선호. 영어 과외 수요 높음.', schools:'속초고, 속초여고' },
      '삼척시': { dongs:['교동','성내동','남양동','근덕면'], feature:'강원 남부 해안 도시. 방문 과외 수요 높음. 합리적 비용 내신 관리 과외 선호.', schools:'삼척고, 삼척여고' },
      '홍천군': { dongs:['홍천읍','화촌면','북방면','남면'], feature:'강원 내륙 농촌 지역. 방문 과외 수요 높음. 홍천읍 중심 내신 관리 과외 수요 꾸준.', schools:'홍천고, 홍천여고' },
      '횡성군': { dongs:['횡성읍','우천면','안흥면','공근면'], feature:'강원 중부 농촌 지역. 횡성한우로 유명. 방문 과외 수요 높음.', schools:'횡성고' },
      '영월군': { dongs:['영월읍','김삿갓면','상동읍','남면'], feature:'강원 남부 소도시. 동강·청령포 관광지 인근. 방문 과외 수요 높음.', schools:'영월고, 영월여고' },
      '평창군': { dongs:['평창읍','대화면','진부면','봉평면'], feature:'동계올림픽 개최지. 알펜시아 리조트 인근. 방문 과외 수요 높음.', schools:'평창고, 대화고' },
      '정선군': { dongs:['정선읍','고한읍','사북읍','신동읍'], feature:'강원 탄광 지역. 카지노 종사자 가정 다수. 합리적 비용 방문 과외 수요 높음.', schools:'정선고, 정선여고' },
      '철원군': { dongs:['철원읍','갈말읍','동송읍','근북면'], feature:'강원 최북단 접경 지역. 군인 가족 비율 높아 방문 과외 수요 높음.', schools:'철원고, 포병고' },
      '화천군': { dongs:['화천읍','간동면','하남면','사내면'], feature:'강원 내륙 소도시. 군부대 인근. 방문 과외 수요 높음.', schools:'화천고' },
      '양구군': { dongs:['양구읍','국토정중앙면','방산면','해안면'], feature:'강원 중부 소도시. 군부대 인근. 방문 과외 수요 높음.', schools:'양구고' },
      '인제군': { dongs:['인제읍','북면','기린면','남면'], feature:'강원 내륙 군사 지역. 방문 과외 수요 높음. 합리적 비용 선호.', schools:'인제고' },
      '고성군': { dongs:['간성읍','거진읍','토성면','죽왕면'], feature:'강원 최북단 해안 지역. 군인 가족 비율 높음. 방문 과외 수요 높음.', schools:'간성고, 거진고' },
      '양양군': { dongs:['양양읍','손양면','현북면','서면'], feature:'강원 동해안 관광 소도시. 서핑 성지로 젊은 층 유입. 방문 과외 수요 높음.', schools:'양양고' },
    }
  },
  '충북': {
    label: '충청북도', emoji: '🌻',
    areas: {
      '청주시': { dongs:['개신동','복대동','산남동','가경동'], feature:'충북도청 소재지. 청주 학원가 형성. 충청권 교육 중심지.', schools:'청주고, 충북고, 청주여고' },
      '충주시': { dongs:['칠금동','용산동','연수동','봉방동'], feature:'충북 제2 도시. 내신 관리 중심 과외 수요 꾸준. 합리적 비용 선호.', schools:'충주고, 충주여고, 예성여고' },
      '제천시': { dongs:['의림지동','모산동','청전동','신백동'], feature:'충북 동부 교육 중심지. 지역 명문 학교 중심 내신 관리 수요 높음.', schools:'제천고, 제천여고' },
      '보은군': { dongs:['보은읍','회인면','속리산면','마로면'], feature:'충북 남부 농촌 지역. 속리산 관광지 인근. 방문 과외 수요 높음.', schools:'보은고, 보은여고' },
      '옥천군': { dongs:['옥천읍','청성면','동이면','군서면'], feature:'충북 남부 소도시. 경부선 철도 인근. 방문 과외 수요 높음.', schools:'옥천고' },
      '영동군': { dongs:['영동읍','용산면','양강면','추풍령면'], feature:'충북 최남단 소도시. 와인 특화 지역. 방문 과외 수요 높음.', schools:'영동고, 영동여고' },
      '증평군': { dongs:['증평읍','도안면'], feature:'충북 최소 군. 청주 인접. 합리적 비용 방문 과외 수요 꾸준.', schools:'증평고' },
      '진천군': { dongs:['진천읍','덕산읍','이월면','백곡면'], feature:'충북 북부 소도시. LG에너지솔루션 공장 인근. 산업단지 종사자 가정 증가.', schools:'진천고, 세광고' },
      '괴산군': { dongs:['괴산읍','칠성면','감물면','장연면'], feature:'충북 중부 농촌 지역. 방문 과외 수요 높음. 합리적 비용 선호.', schools:'괴산고' },
      '음성군': { dongs:['음성읍','금왕읍','삼성면','생극면'], feature:'충북 북부 소도시. 금왕 산업단지 성장. 방문 과외 수요 높음.', schools:'음성고, 음성여고' },
      '단양군': { dongs:['단양읍','매포읍','적성면','대강면'], feature:'충북 최북단 관광 지역. 방문 과외 수요 높음. 합리적 비용 선호.', schools:'단양고' },
    }
  },
  '충남': {
    label: '충청남도', emoji: '🌾',
    areas: {
      '천안시': { dongs:['불당동','두정동','신방동','쌍용동'], feature:'충남 최대 도시. 삼성·현대 등 대기업 종사자 가정 밀집. 수도권 수준 교육열.', schools:'천안고, 천안여고, 오성고' },
      '아산시': { dongs:['배방읍','탕정면','온양동','신창면'], feature:'삼성디스플레이·삼성SDI 인근. IT 기업 가정 집중. 배방 신도시 교육 수요 폭증.', schools:'설화고, 신성고' },
      '서산시': { dongs:['동문동','석남동','대산읍','해미면'], feature:'서해안 교육 중심지. 지역 명문 학교 중심 내신 관리 수요.', schools:'서산고, 서령고' },
      '당진시': { dongs:['당진읍','합덕읍','송악읍','순성면'], feature:'현대제철·당진화력 등 산업단지 인근. 맞벌이 가정 많아 방문 과외 선호.', schools:'호서고, 당진고' },
      '공주시': { dongs:['공주읍','웅진동','신관동','반포면'], feature:'충남 공주대·공주교대 인근. 교육·사범 계열 진학 수요 높음. 공주 학원가 형성.', schools:'공주고, 공주여고' },
      '보령시': { dongs:['대천동','주교면','오천면','청라면'], feature:'충남 서해안 관광도시. 대천해수욕장 인근. 합리적 비용 방문 과외 수요 높음.', schools:'보령고, 대천고' },
      '논산시': { dongs:['논산동','강경읍','연무읍','가야곡면'], feature:'충남 중부 소도시. 훈련소 인근 군인 가족 많음. 육군대학 인근. 방문 과외 수요 높음.', schools:'논산고, 강경고' },
      '계룡시': { dongs:['금암동','두마면','신도안면','엄사면'], feature:'계룡대 인근 군인 도시. 군인 자녀 교육 수요 특화. 방문 과외 선호도 높음.', schools:'계룡고, 계룡중앙고' },
      '금산군': { dongs:['금산읍','추부면','남이면','진산면'], feature:'충남 남부 소도시. 인삼 특화 지역. 방문 과외 수요 높음.', schools:'금산고, 금산여고' },
      '부여군': { dongs:['부여읍','규암면','은산면','외산면'], feature:'백제 역사 문화도시. 역사·문화 교육 관심 높음. 방문 과외 수요 높음.', schools:'부여고, 홍산고' },
      '서천군': { dongs:['장항읍','서천읍','마서면','화양면'], feature:'충남 서해안 소도시. 방문 과외 수요 높음. 합리적 비용 선호.', schools:'장항고, 서천고' },
      '청양군': { dongs:['청양읍','대치면','화성면','청남면'], feature:'충남 중부 소도시. 농촌 지역으로 방문 과외 수요 높음.', schools:'청양고' },
      '홍성군': { dongs:['홍성읍','광천읍','결성면','은하면'], feature:'충남도청 이전 예정지. 내포 신도시 개발로 젊은 가족층 유입. 교육 수요 성장 중.', schools:'홍성고, 홍성여고' },
      '예산군': { dongs:['예산읍','삽교읍','대술면','응봉면'], feature:'충남 북부 소도시. 방문 과외 수요 높음. 합리적 비용 선호.', schools:'예산고, 예산여고' },
      '태안군': { dongs:['태안읍','안면읍','소원면','근흥면'], feature:'충남 서해안 관광지. 태안 기름 유출 복구 후 관광 산업 발달. 방문 과외 수요 높음.', schools:'태안고, 안면고' },
    }
  },
  '전북': {
    label: '전북특별자치도', emoji: '🌾',
    areas: {
      '전주시': { dongs:['서신동','효자동','송천동','평화동'], feature:'전북도청 소재지. 전북 최대 학원가 형성. 전라권 최고 교육 중심지.', schools:'전주고, 전북고, 전주여고' },
      '익산시': { dongs:['영등동','신흥동','팔봉동','어양동'], feature:'전북 제2 도시. 원광대 인근 의대 준비 과외 수요 높음.', schools:'익산고, 원광고' },
      '군산시': { dongs:['나운동','수송동','조촌동','미룡동'], feature:'서해안 산업도시. 현대중공업 인근 이공계 교육 수요 높음.', schools:'군산고, 군산제일고' },
      '정읍시': { dongs:['정읍동','수성동','연지동','시기동'], feature:'전북 중부 소도시. 내장산 관광지 인근. 방문 과외 수요 높음.', schools:'정읍고, 정읍여고' },
      '남원시': { dongs:['남원동','도통동','향교동','광한루원'], feature:'전북 동부 소도시. 춘향전 역사 문화도시. 방문 과외 수요 높음.', schools:'남원고, 남원여고' },
      '김제시': { dongs:['김제동','요촌동','신풍동','검산동'], feature:'전북 서부 농업 도시. 지평선축제로 유명. 방문 과외 수요 높음.', schools:'김제고, 김제여고' },
      '완주군': { dongs:['삼례읍','봉동읍','이서면','고산면'], feature:'전주 인접 위성도시. 전주 학원가 이용 병행. 방문 과외 수요 꾸준.', schools:'완주고, 삼례고' },
      '진안군': { dongs:['진안읍','마령면','백운면','안천면'], feature:'전북 동부 고원 지역. 방문 과외 수요 높음.', schools:'진안고' },
      '무주군': { dongs:['무주읍','설천면','안성면','부남면'], feature:'덕유산·무주리조트 인근. 방문 과외 수요 높음.', schools:'무주고' },
      '장수군': { dongs:['장수읍','번암면','장계면','천천면'], feature:'전북 남부 소도시. 방문 과외 수요 높음.', schools:'장수고' },
      '임실군': { dongs:['임실읍','오수면','관촌면','신평면'], feature:'전북 중부 소도시. 임실 치즈로 유명. 방문 과외 수요 높음.', schools:'임실고' },
      '순창군': { dongs:['순창읍','팔덕면','복흥면','풍산면'], feature:'전북 남부 소도시. 고추장 특화 지역. 방문 과외 수요 높음.', schools:'순창고' },
      '고창군': { dongs:['고창읍','흥덕면','성송면','아산면'], feature:'전북 서해안 소도시. 고창 고인돌 문화재 인근. 방문 과외 수요 높음.', schools:'고창고, 고창여고' },
      '부안군': { dongs:['부안읍','줄포면','변산면','진서면'], feature:'전북 서해안 소도시. 변산반도 국립공원 인근. 방문 과외 수요 높음.', schools:'부안고, 부안여고' },
    }
  },
  '전남': {
    label: '전라남도', emoji: '🍵',
    areas: {
      '순천시': { dongs:['조례동','연향동','풍덕동','왕지동'], feature:'전남 최대 도시. 교육 인프라 우수. 전남 동부권 학생 유학 목적지.', schools:'순천고, 순천여고, 매산고' },
      '여수시': { dongs:['돌산읍','여서동','문수동','미평동'], feature:'여수·광양 산업단지 인근. GS칼텍스·LG화학 종사자 자녀 이공계 교육 수요 높음.', schools:'여수고, 여수여고' },
      '목포시': { dongs:['하당동','남악동','옥암동','용해동'], feature:'전남 서부 교육 중심지. 남악 신도시 개발로 교육 수요 증가.', schools:'목포고, 목포여고' },
      '나주시': { dongs:['나주동','금천면','빛가람동','봉황면'], feature:'전남도청 이전 빛가람 혁신도시. 에너지·공공기관 종사자 가정 급증. 이공계 교육 수요 높아지는 중.', schools:'나주고, 나주여고' },
      '광양시': { dongs:['광양읍','중동','금호동','태인동'], feature:'포스코 광양제철소 인근. 이공계 교육 수요 높음. 금호동 신도시 젊은 가족층 밀집.', schools:'광양고, 광양제철고' },
      '담양군': { dongs:['담양읍','봉산면','창평면','대전면'], feature:'전남 북부 소도시. 죽녹원 관광지 인근. 방문 과외 수요 높음.', schools:'담양고' },
      '곡성군': { dongs:['곡성읍','오곡면','오산면','입면'], feature:'전남 내륙 소도시. 방문 과외 수요 높음.', schools:'곡성고' },
      '구례군': { dongs:['구례읍','토지면','마산면','산동면'], feature:'지리산·섬진강 관광지 인근. 방문 과외 수요 높음.', schools:'구례고' },
      '고흥군': { dongs:['고흥읍','도양읍','포두면','두원면'], feature:'나로우주센터 인근. 우주·과학 교육 관심 높음. 방문 과외 수요 높음.', schools:'고흥고, 고흥여고' },
      '보성군': { dongs:['보성읍','벌교읍','조성면','득량면'], feature:'녹차 특화 지역. 방문 과외 수요 높음.', schools:'보성고' },
      '화순군': { dongs:['화순읍','능주면','동면','이양면'], feature:'광주 인접 소도시. 화순전남대병원 인근 의료계 가정 밀집. 방문 과외 수요 높음.', schools:'화순고, 화순여고' },
      '장흥군': { dongs:['장흥읍','관산읍','대덕읍','안양면'], feature:'전남 남부 소도시. 방문 과외 수요 높음.', schools:'장흥고' },
      '강진군': { dongs:['강진읍','칠량면','대구면','마량면'], feature:'전남 남부 소도시. 다산 정약용 유배지 인근. 방문 과외 수요 높음.', schools:'강진고' },
      '해남군': { dongs:['해남읍','화산면','북일면','산이면'], feature:'한반도 최남단. 방문 과외 수요 높음.', schools:'해남고, 해남여고' },
      '영암군': { dongs:['영암읍','삼호읍','학산면','신북면'], feature:'현대삼호중공업 인근. 조선업 종사자 가정 밀집. 방문 과외 수요 높음.', schools:'영암고' },
      '무안군': { dongs:['무안읍','일로읍','삼향읍','몽탄면'], feature:'전남도청 소재지. 무안국제공항 인근. 공항경제특구 개발로 교육 수요 성장 중.', schools:'무안고' },
      '함평군': { dongs:['함평읍','나비면','신광면','해보면'], feature:'전남 서부 소도시. 나비축제로 유명. 방문 과외 수요 높음.', schools:'함평고' },
      '영광군': { dongs:['영광읍','법성면','홍농읍','군서면'], feature:'한빛원전 인근. 원자력 연구원 가정 밀집. 이공계 교육 수요 높음.', schools:'영광고, 영광여고' },
      '장성군': { dongs:['장성읍','황룡면','북이면','삼서면'], feature:'전남 북부 소도시. 광주 인접. 방문 과외 수요 높음.', schools:'장성고' },
      '완도군': { dongs:['완도읍','금일읍','노화읍','청산면'], feature:'전남 도서 지역. 김·수산물 특화. 온라인 과외 수요 높음.', schools:'완도고, 완도수산고' },
      '진도군': { dongs:['진도읍','의신면','군내면','임회면'], feature:'전남 도서 지역. 진도개·청자 문화. 온라인 과외 수요 높음.', schools:'진도고' },
      '신안군': { dongs:['지도읍','압해읍','비금면','도초면'], feature:'천사대교 연결 다도해 지역. 퍼플섬 관광. 온라인 과외 수요 높음.', schools:'신안중앙고' },
    }
  },
  '경북': {
    label: '경상북도', emoji: '🍎',
    areas: {
      '포항시': { dongs:['양덕동','두호동','환호동','장성동'], feature:'포스코 인근. 이공계 교육 수요 전국 최상위. 포스텍 목표 수학·과학 심화 과외 특화.', schools:'포항고, 포항여고, 장성고' },
      '경주시': { dongs:['황성동','북군동','성건동','용강동'], feature:'역사 도시. 동국대 경주캠퍼스 인근. 문화재·역사 관련 계열 교육 수요 특화.', schools:'경주고, 경주여고' },
      '구미시': { dongs:['원평동','형곡동','임은동','선주원남동'], feature:'삼성·LG·SK 공장 인근. IT 제조업 종사자 자녀 코딩·수학 과외 수요 높음.', schools:'구미고, 구미여고, 오상고' },
      '안동시': { dongs:['옥동','태화동','풍천면','용상동'], feature:'경북도청 소재지. 경북 북부 교육 중심지. 전통 있는 명문 학교 밀집.', schools:'안동고, 안동여고' },
      '경산시': { dongs:['사동','중방동','옥산동','압량읍'], feature:'대구 인접 신흥 도시. 경산 대학가(대구대·경일대·대구한의대) 인근. 대학생 과외 선생님 풍부.', schools:'경산고, 경산여고, 사동고' },
      '김천시': { dongs:['김천동','평화동','율곡동','농소면'], feature:'경북 서부 교통 요충지. KTX 김천구미역 인근. 구미 산업단지 인접으로 이공계 교육 수요 있음.', schools:'김천고, 김천여고' },
      '영주시': { dongs:['영주동','풍기읍','가흥동','상망동'], feature:'경북 북부 소도시. 소백산 인근. 방문 과외 수요 높음.', schools:'영주고, 영주여고' },
      '영천시': { dongs:['영천동','완산동','금호읍','화산면'], feature:'경북 중부 소도시. 대구 인접. 방문 과외 수요 높음.', schools:'영천고, 영천여고' },
      '상주시': { dongs:['상주동','낙동면','함창읍','공성면'], feature:'경북 서부 농업 도시. 방문 과외 수요 높음.', schools:'상주고, 상주여고' },
      '문경시': { dongs:['문경읍','점촌동','가은읍','산양면'], feature:'경북 북서부 소도시. KTX 문경역 개통 예정. 방문 과외 수요 높음.', schools:'문경고, 문경여고' },
      '의성군': { dongs:['의성읍','단촌면','봉양면','금성면'], feature:'경북 중부 소도시. 경북도청 신도시 인근. 방문 과외 수요 높음.', schools:'의성고' },
      '청송군': { dongs:['청송읍','진보면','현서면','파천면'], feature:'경북 내륙 소도시. 주왕산 관광지 인근. 방문 과외 수요 높음.', schools:'청송고' },
      '영양군': { dongs:['영양읍','일월면','입암면','수비면'], feature:'경북 북동부 소도시. 방문 과외 수요 높음.', schools:'영양고' },
      '영덕군': { dongs:['영덕읍','강구면','병곡면','지품면'], feature:'경북 동해안 소도시. 대게로 유명. 방문 과외 수요 높음.', schools:'영덕고' },
      '청도군': { dongs:['화양읍','청도읍','각남면','풍각면'], feature:'경북 남부 소도시. 대구 인접. 방문 과외 수요 높음.', schools:'청도고' },
      '고령군': { dongs:['대가야읍','개진면','성산면','쌍림면'], feature:'대가야 역사 문화도시. 대구 인접. 방문 과외 수요 높음.', schools:'고령고' },
      '성주군': { dongs:['성주읍','선남면','금수면','용암면'], feature:'경북 서부 소도시. 방문 과외 수요 높음.', schools:'성주고' },
      '칠곡군': { dongs:['왜관읍','가산면','동명면','지천면'], feature:'구미·대구 사이 산업 지역. 방문 과외 수요 높음.', schools:'왜관고, 칠곡고' },
      '예천군': { dongs:['예천읍','호명면','지보면','풍양면'], feature:'경북도청 이전 신도시 인근. 공무원 가정 증가로 교육 수요 성장.', schools:'예천고' },
      '봉화군': { dongs:['봉화읍','춘양면','재산면','명호면'], feature:'경북 최북단 소도시. 방문 과외 수요 높음.', schools:'봉화고' },
      '울진군': { dongs:['울진읍','평해읍','죽변면','북면'], feature:'한울원전 인근. 원자력 종사자 가정 밀집. 이공계 교육 수요 높음.', schools:'울진고' },
      '울릉군': { dongs:['울릉읍','서면','북면'], feature:'독도 수호 섬 지역. 온라인 과외 수요 높음. 합리적 비용 선호.', schools:'울릉고' },
    }
  },
  '경남': {
    label: '경상남도', emoji: '🌊',
    areas: {
      '창원시': { dongs:['상남동','봉곡동','중앙동','신월동'], feature:'경남도청 소재지. 현대위아·두산중공업 인근. 이공계 교육 수요 높음.', schools:'창원고, 창원여고, 경남고' },
      '진주시': { dongs:['신안동','평거동','초전동','문산읍'], feature:'경상대·진주교대 인근. 경남 교육 중심지. 사범·교육 계열 진학 수요 높음.', schools:'진주고, 진주여고' },
      '김해시': { dongs:['장유동','내외동','불암동','삼계동'], feature:'부산 인접 급성장 도시. 부산 수준의 교육열. 장유 신도시 교육 수요 폭증.', schools:'김해고, 김해여고, 장유고' },
      '양산시': { dongs:['물금읍','양산동','북정동','신기동'], feature:'부산 바로 옆. 부산대 인근 영향. 물금 신도시 개발로 젊은 가족층 대거 유입.', schools:'양산고, 양산여고' },
      '거제시': { dongs:['고현동','장승포동','아주동','수월동'], feature:'삼성중공업·대우조선 인근. 조선업 종사자 가정 밀집. 자녀 교육에 대한 투자 의지 높음.', schools:'거제고, 거제여고' },
      '통영시': { dongs:['통영동','무전동','도천동','미수동'], feature:'한국의 나폴리. 조선·해양 산업 인근. 방문 과외 수요 높음.', schools:'통영고, 통영여고' },
      '사천시': { dongs:['사천읍','용현면','정동면','향촌동'], feature:'한국항공우주산업(KAI) 본사 인근. 항공·우주 이공계 교육 수요 특화.', schools:'사천고, 사천여고' },
      '밀양시': { dongs:['삼문동','내이동','가곡동','상남면'], feature:'경남 내륙 소도시. 부산 인접. 방문 과외 수요 높음.', schools:'밀양고, 밀양여고' },
      '의령군': { dongs:['의령읍','칠곡면','대의면','화정면'], feature:'경남 서부 소도시. 방문 과외 수요 높음.', schools:'의령고' },
      '함안군': { dongs:['가야읍','함안면','칠원면','군북면'], feature:'경남 중부 소도시. 방문 과외 수요 높음.', schools:'함안고, 함안여고' },
      '창녕군': { dongs:['창녕읍','남지읍','유어면','대지면'], feature:'우포늪 생태도시. 방문 과외 수요 높음.', schools:'창녕고' },
      '고성군': { dongs:['고성읍','삼산면','하이면','거류면'], feature:'경남 남부 공룡 화석 지역. 방문 과외 수요 높음.', schools:'고성고' },
      '남해군': { dongs:['남해읍','설천면','미조면','삼동면'], feature:'경남 도서 지역. 독일마을·다랭이마을 관광지. 방문 과외 수요 높음.', schools:'남해고' },
      '하동군': { dongs:['하동읍','금남면','화개면','악양면'], feature:'섬진강·지리산 관광지. 방문 과외 수요 높음.', schools:'하동고' },
      '산청군': { dongs:['산청읍','단성면','신안면','금서면'], feature:'지리산 인근 소도시. 방문 과외 수요 높음.', schools:'산청고' },
      '함양군': { dongs:['함양읍','안의면','수동면','마천면'], feature:'경남 내륙 소도시. 방문 과외 수요 높음.', schools:'함양고' },
      '거창군': { dongs:['거창읍','웅양면','남상면','가조면'], feature:'경남 북부 소도시. 거창국제연극제 문화도시. 방문 과외 수요 높음.', schools:'거창고, 거창여고' },
      '합천군': { dongs:['합천읍','가야면','묘산면','봉산면'], feature:'합천댐·황매산 관광지. 방문 과외 수요 높음.', schools:'합천고' },
    }
  },
  '제주': {
    label: '제주특별자치도', emoji: '🌺',
    areas: {
      '제주시': { dongs:['노형동','이도동','연동','아라동'], feature:'제주도청 소재지. 제주국제자유도시 개발로 이주 가정 급증. 영어교육도시 인접 영어 교육 수요 높음.', schools:'제주고, 제주여고, 남녕고' },
      '서귀포시': { dongs:['서귀동','대정읍','성산읍','표선면'], feature:'제주 남부 교육 중심지. 글로벌 영어교육도시(NLCS·BHA 등) 인근. 국제학교 준비 과외 수요 특화.', schools:'서귀포고, 서귀포여고' },
    }
  },
};
